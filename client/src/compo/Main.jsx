...
export const Main = () => {
  ...
  return (
    <>
      <div className="w-screen h-auto flex flex-col cursor-pointer items-center">
        <div className=" flex items-center space-x-5 mb-5 mt-20">
          <div
            className={`${style0}  font-thin text-yellow-600
           cursor-pointer`}
            onClick={() => {
              setVal(0);
              setStyle1("text-2xl");
          ...
          <div
            className={`${style1} font-thin text-yellow-600 cursor-pointer`}
            onClick={() => {
              setVal(1);
              setStyle0("text-2xl");
              setStyle1("text-3xl");
        ...
        <div className="z-20 absolute right-28 ml-10 top-10">
