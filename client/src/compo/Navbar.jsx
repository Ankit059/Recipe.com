...
export const Navbar = () => {
  return (
    <>
      <div className="w-screen h-14  bg-gray-800">
        <div className="relative">
          ...
          <div className="w-3/6 h-14 absolute top-0 right-0  ">
            <Star
            ...
            <input
              className="absolute right-3 top-2.5 w-5/6 h-10 rounded-xl text-lg font-semibold pl-10 "
              type="text"
