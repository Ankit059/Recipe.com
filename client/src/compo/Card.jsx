...
export const Card = () => {
  return (
    <>
      <div className="flex flex-col  rounded-xl w-96 h-80 m-8  ">
        <Link to="/description" className="border-2 flex justify-center items-center h-60 w-96  rounded-t-xl hover:overflow-visible  rounded-t-xl bg-gray-900  cursor-pointer">
          <img src={food} alt="img" className="w-96 h-60 rounded-t-xl border-2 border-black" />
        </Link>
