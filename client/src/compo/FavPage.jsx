    ...
    <>
        <div className="w-screen h-auto flex flex-col items-center border-2 border-black">
            <div className="mt-4 h-20 flex font-serif  border-black">
                <img src={Star} className='mt-10 w-10 h-10 text-yellow-700 mr-1' alt="star" />
                <div className="mt-10 text-4xl text-yellow-600 font-bold underline">F@vour!tes </div>
            ...
            <div className="w-4/6 h-auto  border-black  mt-4">
